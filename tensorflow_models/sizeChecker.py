...
# Directories
train_directory = './drone_images/test' # It should contain the xml files with bounding boxes
test_directory = './drone_images/test' # It should contain the xml files with bounding boxes
